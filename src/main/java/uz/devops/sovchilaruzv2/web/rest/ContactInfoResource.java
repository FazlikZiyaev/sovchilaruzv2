...
import uz.devops.sovchilaruzv2.service.ContactInfoService;
...
/**
 * REST controller for managing {@link uz.devops.sovchilaruzv2.domain.ContactInfo}.
 */
@RestController
...
public class ContactInfoResource {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<ContactInfoDTO> getContactInfo(@PathVariable UUID id) {
