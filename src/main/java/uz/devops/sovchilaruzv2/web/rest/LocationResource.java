...
import uz.devops.sovchilaruzv2.service.LocationService;
...
/**
 * REST controller for managing {@link uz.devops.sovchilaruzv2.domain.Location}.
 */
@RestController
...
public class LocationResource {
    ...
    public ResponseEntity<List<LocationDTO>> getAllLocations(
        ...
        if ("profile-is-null".equals(filter)) {
            log.debug("REST request to get all Locations where profile is null");
            return new ResponseEntity<>(locationService.findAllWhereProfileIsNull(), HttpStatus.OK);
        }
