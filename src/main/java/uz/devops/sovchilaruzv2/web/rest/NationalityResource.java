...
import uz.devops.sovchilaruzv2.service.NationalityService;
...
/**
 * REST controller for managing {@link uz.devops.sovchilaruzv2.domain.Nationality}.
 */
@RestController
...
public class NationalityResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<NationalityDTO>> getAllNationalities(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<NationalityDTO> getNationality(@PathVariable UUID id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteNationality(@PathVariable UUID id) {
