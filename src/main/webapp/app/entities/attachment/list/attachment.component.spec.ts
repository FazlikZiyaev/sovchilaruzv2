...
describe('Attachment Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'attachment', component: AttachmentComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.attachments?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });
