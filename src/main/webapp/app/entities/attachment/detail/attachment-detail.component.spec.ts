...
describe('Attachment Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { attachment: () => of({ id: '9fec3727-3421-4967-b213-ba36557ca194' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load attachment on init', async () => {
      ...
      // THEN
      expect(instance.attachment).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
});
