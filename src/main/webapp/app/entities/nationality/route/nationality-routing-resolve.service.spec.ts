...
import nationalityResolve from './nationality-routing-resolve.service';
  ...
  describe('resolve', () => {
    it('should return INationality returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        nationalityResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
      ...
      expect(resultNationality).toEqual({ id: '9fec3727-3421-4967-b213-ba36557ca194' });
    });
