...
describe('Profile Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { profile: () => of({ id: '9fec3727-3421-4967-b213-ba36557ca194' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load profile on init', async () => {
      ...
      // THEN
      expect(instance.profile).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
});
