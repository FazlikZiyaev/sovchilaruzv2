...
class LocationResourceIT {
    ...
    void createLocation() throws Exception {
        ...
        assertThat(testLocation.getOrd()).isEqualTo(DEFAULT_ORD);
    ...
    void putExistingLocation() throws Exception {
        ...
        assertThat(testLocation.getOrd()).isEqualTo(UPDATED_ORD);
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.lat(UPDATED_LAT).city(UPDATED_CITY).district(UPDATED_DISTRICT);
