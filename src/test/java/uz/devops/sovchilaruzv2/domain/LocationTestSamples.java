...
public class LocationTestSamples {
    ...
    public static Location getLocationSample1() {
        return new Location().id(1L).country("country1").city("city1").district("district1").ord(1);
    }

    public static Location getLocationSample2() {
        return new Location().id(2L).country("country2").city("city2").district("district2").ord(2);
    }
